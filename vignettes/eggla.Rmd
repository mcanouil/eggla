...
## 2. Run the script using a Docker container
...
## 4. Create `run_eggla_gwas.R` Script
...
## 5. Run the script using a Docker container
...
## 2. Start R and setup environement
