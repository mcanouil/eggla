...
1. Copy and edit the following code to a new file (_e.g._, `run_eggla.sh`) on the server that will run the analysis with the appropriate parameters.
  ...
  - `renv` (recommended):
    ...
    Rscript \
      ...
      -e 'utils::download.file(
        url = "https://raw.githubusercontent.com/mcanouil/eggla/main/inst/setup/renv.lock",
        destfile = "renv.lock"
      )' \
  ...
  - `pak` (faster):
    ...
    Rscript \
      ...
      -e 'library(pak)' \
      -e 'utils::download.file(
        url = "https://raw.githubusercontent.com/mcanouil/eggla/main/inst/setup/pkg.lock",
        destfile = "pkg.lock"
      )' \
