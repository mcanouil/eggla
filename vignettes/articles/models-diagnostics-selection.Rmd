---
title: "Models Diagnostics & Selection"
params:
  pheno_dt: !r setDT(get(data("bmigrowth", package = "eggla")))
---
...
```{r future-setup}
plan("multicore", workers = min(40, availableCores()))
...
all_models <- all_models[# subset
  sub(".*random = ", "", models) %in% random_effect[c(1, 3, 8)] &
