...
1. Copy the following code to a new file (e.g., `run_eggla.sh`) on the server that will run the analysis with appropriate parameters.
...
Rscript -e '
  ...
  run_eggla(
    ...
    parallel = FALSE, # to parallelise Daymont's QC
    parallel_n_chunks = 1, # to parallelise Daymont's QC
