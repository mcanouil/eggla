...
COPY bin/plink2 /usr/bin/plink2
RUN chmod +x /usr/bin/plink2

ARG RIG_VERSION=latest
ARG R_VERSION="4.2.0"
COPY setup/pkg.lock pkg.lock
...
COPY setup/eggla-example.R eggla-example.R
